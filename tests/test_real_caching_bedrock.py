"""
Real caching integration test for Bedrock Anthropic models.

This test requires:
1. AWS credentials (AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_SESSION_TOKEN if needed)
2. Access to Bedrock Anthropic models in your AWS account
3. Actual API credits (will use real tokens)
4. Minimum 1024 tokens to be cached (per Anthropic's requirements)

Run with: python tests/test_real_caching_bedrock.py
"""
