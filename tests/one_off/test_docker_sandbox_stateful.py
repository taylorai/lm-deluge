"""Tests for DockerSandbox stateful mode using persistent shell."""
...
async def test_stateless_mode_no_state_persistence():
    ...
    async with DockerSandbox(stateful=False) as sandbox:
        # Set a variable
...
async def test_stateful_mode_variable_persistence():
    ...
    async with DockerSandbox(stateful=True) as sandbox:
        # Set a variable
...
async def main():
    ...
    print("Testing DockerSandbox stateful mode...")
    ...
    print("\n✅ All DockerSandbox stateful mode tests passed!")
