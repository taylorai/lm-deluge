...
These tools are basically LLM-powered functions/workflows -- they are built out of input/output definitions, a prompt, and response parsing. That's about it!
