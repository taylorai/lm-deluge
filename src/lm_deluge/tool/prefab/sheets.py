...
class SheetsManager:
    ...
    def _read_range(self, range_spec: str) -> str:
        ...
        try:
            ...
            # Convert to HTML table with row/col attributes
            ...
            for row_idx, row in enumerate(values, start=1):
                ...
                for col_idx, cell_value in enumerate(row, start=1):
                    ...
                    html_parts.append(
                        f'<td row="{row_idx}" col="{col_letter}" cell="{cell_ref}">{cell_value}</td>'
                    )
                html_parts.append('</tr>')
        ...
        self._tools = [
            Tool(
                ...
                description=(
                    ...
                    "Each cell in the table has 'row', 'col', and 'cell' attributes indicating "
                    "its position (e.g., row='1', col='A', cell='A1'). "
