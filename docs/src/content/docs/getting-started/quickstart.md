...
`LLMClient` ships with high throughput defaults (`1_000` requests/minute, `500_000` tokens/minute, and a temperature of `1.0`). Pass the model ID you want to start sending prompts immediately:
